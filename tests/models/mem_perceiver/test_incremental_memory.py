...
input_lens = [16384]
generate_lens = [1]
incremental_types = [LayerwiseIncrementalType.DOUBLE_INVERSE]
# incremental_types = [IncrementalType.LINEAR, IncrementalType.SQRT, IncrementalType.SQUARE, IncrementalType.INVERSE_CONCAVE, IncrementalType.INVERSE_CONVEX, LayerwiseIncrementalType.SQUARE_SQRT, LayerwiseIncrementalType.DOUBLE_INVERSE, LayerwiseIncrementalType.ADAPTIVE]
